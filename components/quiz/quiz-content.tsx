...
export const QuizContent: React.FC = () => {
    ...
    const hasDirectionParam = searchParams.direction !== undefined;
    ...
    const replaceSetupState = (ids: string[], nextDirection: QuizDirection = direction) => {
        ...
        void navigate({
            to: '/quiz',
            search: searchFromQuery(nextQuery),
            replace: true,
            resetScroll: false,
        });
    };
    ...
    const startQuiz = () => {
        ...
        void navigate({ to: '/quiz/session', search: searchFromQuery(nextQuery) });
    };
